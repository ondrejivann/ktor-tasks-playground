...
import infrastructure.graphql.model.PrepareTaskAttachmentUploadRequestGQL
import infrastructure.graphql.model.PrepareTaskAttachmentUploadResponseGQL
import infrastructure.graphql.model.TaskAttachmentDetailGQL
import infrastructure.graphql.model.TaskAttachmentOperationResultGQL
import infrastructure.graphql.model.createAttachmentErrorResponse
import infrastructure.graphql.model.createPrepareUploadErrorResponse
import infrastructure.graphql.model.toGQL
import io.github.oshai.kotlinlogging.KotlinLogging
import org.koin.core.annotation.Single

@Single
class TaskAttachmentMutations(private val taskAttachmentDetailService: TaskAttachmentDetailService) {
    ...
    suspend fun removeAttachment(attachmentId: Int): TaskAttachmentOperationResultGQL = try {
